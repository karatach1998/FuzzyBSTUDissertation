...
\setrmarg{2.55em}                             %To have the (sectional) titles in the ToC, etc., typeset ragged right with no hyphenation
\renewcommand{\cftchapterpagefont}{\normalfont}        % нежирные номера страниц у глав в оглавлении
\renewcommand{\cftchapterleader}{\cftdotfill{\cftchapterdotsep}}% нежирные точки до номеров страниц у глав в оглавлении
% Сделать названия глав в оглавлении небold и в верхнем регистре
\renewcommand{\cftchapterfont}{\raggedright\normalfont\MakeUppercase} % нежирные названия глав в оглавлении
...
\makechapterstyle{thesisgost}{%
    ...
    \renewcommand*{\printchaptertitle}[1]{%
        ...
        \ifthischapternumbered
            \MakeUppercase{\@chapapp\space\thechapter.\space##1}%
        \else
            \MakeUppercase{##1}%
        \fi
    }%
...
%%% Установить одинаковый отступ для section и более глубоких уровней в оглавлении.
%%% Отступ выбран 2.55em (как в \setrmarg), резерв для номера — 3em.
\AfterEndPreamble{%
    ...
    \cftsetindents{section}{1.5em}{1.85em}
    \cftsetindents{subsection}{1.5em}{2.65em}
    \cftsetindents{subsubsection}{1.5em}{2.55em}
}
