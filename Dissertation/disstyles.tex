...
\newcommand{\basegostsectionfont}{\fontsize{14pt}{14pt}\selectfont\OnehalfSpacing\bfseries}
...
\ifnumequal{\value{headingsize}}{1}{% Пропорциональные заголовки и базовый шрифт 14 пт
    \renewcommand{\basegostsectionfont}{\large\OnehalfSpacing\bfseries}
    \renewcommand*{\chapnamefont}{\Large\OnehalfSpacing\bfseries}
    \renewcommand*{\chapnumfont}{\Large\OnehalfSpacing\bfseries}
    \renewcommand*{\chaptitlefont}{\Large\OnehalfSpacing\bfseries}
}{}
