...
\chapter{Свидетельства о государственной\linebreak регистрации программ для ЭВМ}\label{app:B}
...
\chapter{Справка о практическом применении результатов диссертационной работы в организации}\label{app:C}
\includegraphics[width=0.80\textwidth, page=1]{images/act-practical.pdf}

\chapter{Акт о внедрении результатов\linebreak диссертационной работы в учебный процесс}\label{app:D}
