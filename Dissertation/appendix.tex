...
\addtocontents{toc}{\protect\cftsetindents{section}{0.0em}{3.5cm}}

\titleformat{\section}[display]
{\normalfont\filcenter\bfseries}
{\appendixname\space\thesection}
{1ex minus .1ex}
{\filcenter\textnormal{{(справочное)}}\\\vspace{3ex}}
...
\newpage
\section{Свидетельства о государственной\linebreak регистрации программ для ЭВМ}\label{app:B}

\includegraphics[width=0.8\textwidth, page=1]{images/RosPatent1.pdf}

\includegraphics[width=0.8\textwidth, page=1]{images/RosPatent2.pdf}

\section{Справка о практическом применении результатов диссертационной работы в организации}\label{app:C}
\includegraphics[width=0.80\textwidth, page=1]{images/act-practical.pdf}

\section{Акт о внедрении результатов\linebreak диссертационной работы в учебный процесс}\label{app:D}
\includegraphics[width=0.86\textwidth, page=1]{images/act-education.pdf}
