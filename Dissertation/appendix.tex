...
\addtocontents{toc}{\protect\renewcommand{\protect\cftsectionpresnum}{\appendixname\space}}
\addtocontents{toc}{\protect\renewcommand{\protect\cftsectionaftersnum}{\space(справочное)\space}}
\addtocontents{toc}{\protect\settowidth{\protect\cftsectionnumwidth}{\cftsectionpresnum\thesection\cftsectionaftersnum}}
\addtocontents{toc}{\protect\cftsetindents{section}{0.0em}{6.3cm}}

\titleformat{\section}[display]
{\normalfont\filcenter\bfseries}
{\appendixname\space\thesection}
{1ex minus .1ex}
{\filcenter\textnormal{\textbf{(справочное)}}\\\vspace{3ex}}

% Нумеровать приложения как \section с буквенными обозначениями
% и префиксом "Приложение A. " перед названием.
\renewcommand{\thesection}{\Asbuk{section}}
\setsecnumformat{\appendixname\space\csname the#1\endcsname.\space}
%\setcounter{section}{0}


\section{Текст программного кода Python-модуля нечеткого вывода с использованием технологии CUDA}\label{app:A}
...
\begin{ListingEnv}
	...
	\label{lst:cython}
\end{ListingEnv}
\begin{minted}[fontsize=\footnotesize,tabsize=2,breaklines,breaksymbolleft=\tiny\space]{cython}
...
\newpage
\section{Свидетельства о государственной регистрации программ для ЭВМ}\label{app:B}
\counterwithin{figure}{section}

\FloatBarrier

\setcounter{figure}{0} % Reset figure counter to 0 so next figure is numbered 1

\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth, page=1]{images/RosPatent1.pdf}
\caption{Свидетельство о государственной регистрации программы для ЭВМ №~2025663372}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth, page=1]{images/RosPatent2.pdf}
\caption{Свидетельство о государственной регистрации программы для ЭВМ №~2025663464}
\end{figure}

\newpage
\section{Акты внедрения результатов диссертации}\label{app:C}
\counterwithin{figure}{section}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth, page=1]{images/act-practical.pdf}
\caption{Справка о практическом применении результатов диссертационной работы в организации}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth, page=1]{images/act-education.pdf}
\caption{Акт о внедрении результатов\linebreak диссертационной работы в учебный процесс}
\end{figure}
%\includepdf[pages=-]{images/act-practical.pdf}